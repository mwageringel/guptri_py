...
project = 'guptri_py'
copyright = '2020, Markus Wageringel'
author = 'Markus Wageringel'
package_folder = "../guptri_py"
...
#
html_theme_options = {
    'github_user': 'mwageringel',
    'github_repo': 'guptri_py',
    'github_banner': 'true',
}
...
htmlhelp_basename = 'guptri_pydoc'
...
latex_documents = [
    (master_doc, 'guptri_py.tex', u'guptri\\_py Documentation',
...
man_pages = [
    (master_doc, 'guptri_py', u'guptri_py Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'guptri_py', u'guptri_py Documentation',
     author, 'guptri_py', 'One line description of project.',
     'Miscellaneous'),
]
